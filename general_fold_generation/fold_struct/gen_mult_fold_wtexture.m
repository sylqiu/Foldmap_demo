function [sing_cell,sing_xy_cell,bdy_ind,new_vertex,vertex,new_constraints,varargout] = ...
    gen_mult_fold_wtexture(imagefilename,m,n,mm,nn,kk,wtexture)
...
% figure(2); gpp_plot_mesh(face,new_vertex_3d); view(2);
